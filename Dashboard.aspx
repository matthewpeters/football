  ...
  <div id="navButtonContainer">
    ...
    <div id="actionsContainer" style="float:left;width:45%;display:inline;">
        ...
        <div id="userActionsContainer">
            <div id="userProfile" class="">
                <div style="color:#a6a6a6;position:absolute;margin-top:-15px;margin-left:78%;" onclick="closeAllPopups();">[close]</div>
                <h4>Your Profile</h4>
                <table style="float:left;">
                    <tr>
                        <td style="text-align:right;">Display Name:</td>
    ...
    <div id="reportsContainer">
        ...
        <div id="report3" class="">
            <div style="color:#a6a6a6;position:absolute;margin-top:-15px;margin-left:72%;" onclick="closeAllPopups();">[close]</div>
        ...
        <div id="report4" class="">
            <div style="color:#a6a6a6;position:absolute;margin-top:-15px;margin-left:90%;" onclick="closeAllPopups();">[close]</div>
